\subsection{Bewertung der Testergebnisse}\label{subsec:bewertung_der_testergebnisse}
...
\begin{table}[htbp]
\centering
\caption{Metriken Wetterstein 100m Abstand}
...
\begin{table}[htbp]
\centering
\caption{Metriken Wetterstein 45m Manchattendistanz}
\label{tab:metrics_45m_square}
\begin{tabular}{|l|r|}
\hline
Metrik & Wert \\
\hline
...
\begin{table}[htbp]
\centering
\caption{Metriken Wetterstein 1000m Abstand}
...
\begin{table}[htbp]
\centering
\caption{Metriken Feldberg 5m Manchattendistanz}
...
\begin{table}[htbp]
\centering
\caption{Metriken Feldberg 100m Abstand}
...
\begin{table}[htbp]
\centering
\caption{Metriken Südschwarzwald 15m Manchattendistanz}
...
\begin{table}[htbp]
\centering
\caption{Metriken Südschwarzwald 100m Abstand}
...
\begin{table}[htbp]
\centering
\caption{Metriken Südschwarzwald 1000m Abstand}
